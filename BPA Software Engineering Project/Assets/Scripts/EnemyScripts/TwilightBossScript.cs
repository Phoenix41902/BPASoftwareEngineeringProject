...
public class TwilightBossScript : MonoBehaviour
{
    // move spots
    ...
    private void Start()
    {
        fightHasStarted = TwilightGameController.instance.BossFightStarted;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.tag == "PlayerSub") SubScript.instance.subHealth--;
    }
}
